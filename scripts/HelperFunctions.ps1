...
Function Get-BlobFromPrivateAzureStorageOauth2 {
    ...
    Get-FileWithCustomerHeader -sourceUrl $blobUri -destinationFile $TempFile -headers $headers
...
<#
 ...
 .Example
  Get-FileWithCustomerHeader -sourceUrl "https://myurl/file.zip" -destinationFile "c:\temp\file.zip" -dontOverwrite
#>
function Get-FileWithCustomerHeader {
    Param (
